...
export const sendTokenUpdatedEvent = (stream: Stream, userName: string, token?: string) => {
    sendEventToStream(
        stream,
        {
...
export const sendPasswordUpdatedEvent = (stream: Stream, userName: string, pass: string) => {
    sendEventToStream(
        stream,
        {
